...
import VerifyHomeCard from "../adminComponents/VerifyProducts/VerifyHomeCard";
  ...
  useEffect(() => {
    const fun = async () => {
      try {
        ...
        const URL =
          "https://laviour.herokuapp.com/api/products/pendingVerification";
