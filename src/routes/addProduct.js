    ...
    <SellerProtectedRoute>
      <div className="h-[100%]">
        ...
        <div className="lg:ml-[15%] ">
          <h3 className="text-[#000] font-extrabold text-3xl mt-4 ml-8 md:mt-12 md:w-[60%] md:mx-auto">
            Add A Product
          </h3>
          ...
          <div className="rounded-2xl mx-auto bg-[#000] p-6  w-[90%] h-[68%] sm:h-[55%] sm:mt-8 mt-4 md:w-[80%] sm:w-[90%] lg:w-[60%] lg:h-[70%] lg:mt-8 lg:mx-0  md:mt-8 md:h-[70%]  ">
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <div>
                <label className="text-white font-bold mt-4 mb-2">
                  Enter the discounted price (This is the amount you will
                  receive)
                </label>
                <input
                  value={price}
              ...
              <div>
                <label className="text-white font-bold mt-4 mb-2">
                  Enter the MRP (This is the MRP of the product)
                </label>
                <input
                  value={MRP}
                  onChange={(e) => {
              ...
              <div className="flex justify-center">
                {isLoading ? (
                  <button className="bg-[#df1f98de] mt-4 w-32 text-center rounded-full text-white px-8 py-1 font-bold ml-2 ">
                    <svg
                      role="status"
