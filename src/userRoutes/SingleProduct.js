...
import ProductContent from "../userComponents/SingleProduct/ProductContent";
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
// import "../userComponents/Card/cards.css";
import "../userComponents/SingleProduct/prod.css";

import Slider from "react-slick";
import SizechartModal from "../userComponents/SingleProduct/SizechartModal";
  ...
  useEffect(() => {
    const fun = async () => {
      ...
      const response = await axios.get(
        `https://laviour.herokuapp.com/api/product/${id}`
      );
      if (response.data) {
    ...
    <Layout>
      ...
      {prodLoading ? (
        ...
        <div className="sm:flex lg:justify-between justify-around mx-auto">
          <div className="lg:w-[30%] md:mt-4 lg:ml-56 sm:w-[45%] ml-4 w-[80%] mx-auto sm:mx-none ">
